...
var SubmitScenarios = []SubmitScenario{
	{
		...
		Events: []submitAction.Event{
			...
			submitAction.PreparingEvent{},
			submitAction.PreparingEvent{Completed: true},
			...
			submitAction.PushEvent{BranchCount: 2},
			submitAction.PushEvent{BranchCount: 2, Completed: true},
